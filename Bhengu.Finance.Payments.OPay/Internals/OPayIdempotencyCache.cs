...
/// <summary>
/// Idempotency-key deduplication helper for OPay operations. OPay does NOT expose a native
...
/// that coalesces concurrent in-flight calls so a stampede of retries against the same key cannot
/// reach OPay more than once.</para>
/// </remarks>
public sealed class OPayIdempotencyCache
{
    ...
    public OPayIdempotencyCache(IBhenguDistributedCache cache)
    {
        ...
        CancellationToken ct = default) where T : class
    {
        ...
        var cacheKey = $"opay:idemp:{operation}:{idempotencyKey}";
