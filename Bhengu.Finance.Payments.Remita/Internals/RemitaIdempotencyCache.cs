...
/// <summary>
/// Idempotency-key deduplication helper for Remita operations. Remita does NOT expose a native
...
/// </remarks>
public sealed class RemitaIdempotencyCache
{
    ...
    public RemitaIdempotencyCache(IBhenguDistributedCache cache)
    {
        ...
        CancellationToken ct = default) where T : class
    {
        ...
        var cacheKey = $"remita:idemp:{operation}:{idempotencyKey}";
