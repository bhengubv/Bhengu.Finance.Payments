...
/// <summary>OTel counter assertions for the AirtelMoney provider family.</summary>
public class AirtelMoneyDiagnosticsTests
{
    [Fact]
...
""".Trim()));
        var provider = new AirtelMoneyPaymentProvider(
            new HttpClient(handler),
            Options.Create(new AirtelMoneyOptions { ClientId = "cid", ClientSecret = "cs", Country = "UG", Currency = "UGX" }),
        ...
        Assert.True(recorder.CounterTotalFor("bhengu_payments_charges_total", "airtelmoney") >= 1);
    }
}